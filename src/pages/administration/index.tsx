...
const Administration: React.FC = () => {
  ...
  return (
    <>
      ...
      />
      <div className='m-4 relative grid grid-cols-12 gap-x-4'>
        <Card 
          className="sticky top-0 col-span-2 h-52" 
          bodyStyle={{padding: 0}} 
          title={
            <Text className="font-semibold text-primary">CONFIGS</Text>
            }
          ...
          >
            ...
            <div 
              className={`
                ...
                transition-colors
                ${activeConfigTab === tab.title && 'font-semibold border-r-2 bg-success bg-opacity-30'}`
                }
