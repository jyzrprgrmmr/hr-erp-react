...
const BusinessConfig: React.FC<BusinessConfigProps> = ({setActiveBusinessConfig}) => {
    return (
         <Card 
            ...
            <div className="flex items-center justify-between">
                ...
                <Button type="link" size="small" onClick={()=>setActiveBusinessConfig(undefined)} icon={<ArrowLeftOutlined/>}>Go back to business list</Button>
            </div>
            }
        >
            <div className="grid grid-cols-12">
                <div className="col-span-3 border-r border-success">
                    <div className="bg-primary font-semibold p-3">
                        ...
                        <Form layout="vertical" className="p-4">
                            ...
                            <Button className="w-full" type="primary" icon={<SendOutlined/>}>Save</Button>
                        </Form>
                </div>
